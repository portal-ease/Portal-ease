    ...
    <section class="bg-white py-20 px-6 md:px-28">
        ...
        <div class="space-y-6 max-w-4xl mx-auto">
            <div class="bg-blue-50 rounded-xl p-6 shadow-lg">
                ...
                <p class="text-blue-800 text-lg">Simply click on "Try for free" and follow the step-by-step instructions
                    to set up your personalized portal in minutes.</p>
            </div>
            <div class="bg-blue-50 rounded-xl p-6 shadow-lg">
                <h3 class="text-2xl font-semibold text-blue-800 mb-2">Can I share documents securely?</h3>
                <p class="text-blue-800 text-lg">Yes, Portalease ensures that all documents, invoices, and messages are
                    securely shared with your clients.</p>
            </div>
            <div class="bg-blue-50 rounded-xl p-6 shadow-lg">
                <h3 class="text-2xl font-semibold text-blue-800 mb-2">Is there a mobile app?</h3>
                <p class="text-blue-800 text-lg">Currently, Portalease is fully accessible via any web browser on mobile
                    devices for convenience on the go.</p>
            </div>
            <div class="bg-blue-50 rounded-xl p-6 shadow-lg">
                <h3 class="text-2xl font-semibold text-blue-800 mb-2">How do I invite clients?</h3>
                <p class="text-blue-800 text-lg">Open your portal dashboard, go to Clients and send an invitation by
                    email. Your client will receive a secure link to access their portal.</p>
            </div>
        </div>
    </section>
