...
<body class="flex min-h-screen items-center justify-center bg-gray-50 px-6">
    <div class="flex max-w-xl flex-col items-center text-center">
        ...
        <p class="text-7xl font-extrabold text-red-600">500</p>

        <h1 class="mt-6 text-3xl font-bold text-gray-900">Something went wrong</h1>

        <p class="mt-4 text-gray-600">
            Something went wrong on our end. Please try again later. If the problem continues, please contact support.
        </p>
