...
<!-- Logo + Navigation -->
<a href="/"
   class="flex items-center self-start text-xl font-semibold p-5 text-blue-700 hover:text-blue-900 transition">
    <img src="{{ asset('portalEaseLogo.png') }}" alt="PortalEase logo" class="max-h-12 mr-2">
    <span>
