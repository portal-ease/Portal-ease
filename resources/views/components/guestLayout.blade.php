    ...
    <header class="flex items-center justify-between px-8 py-4 shadow-sm">
        ...
        <div class="flex items-center space-x-4">
            <a href="{{ route('portal.index') }}"
                class="px-4 py-2 bg-blue-600 text-white rounded-xl shadow hover:bg-blue-700 transition">Log in</a>
        </div>
    </header>
    <!-- Main Content -->
    <div>
        ...
        <div class="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="https://www.youtube.com/channel/UC-HSpoaud4ZjTlPdTBtW0Ig"
                            class="hover:underline">Tutorials</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    <!-- Instagram -->
                    <a href="https://www.instagram.com/portalease" class="text-blue-200 hover:text-white"
                    ...
                    <!-- YouTube -->
                    <a href="https://www.youtube.com/channel/UC-HSpoaud4ZjTlPdTBtW0Ig"
                        class="text-blue-200 hover:text-white" aria-label="YouTube">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <!-- LinkedIn -->
                    <a href="https://www.linkedin.com/company/portalease/?viewAsMember=true"
                        class="text-blue-200 hover:text-white" aria-label="LinkedIn">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path
